  void main(List<String> args) {
    ...
    v1.monter(w.wagonVoyageur);
    w.wagonMarchand.affreter(m);
...
class WagonDouble extends Wagon {
  ...
  var wagonVoyageur = new WagonVoyageur();
  var wagonMarchand = new WagonMarchandise();

  String afficher() {
    return wagonVoyageur.afficher() + wagonMarchand.afficher();
  }
}
